...
# Load data
source(here("scripts", "01_data_load.R"))
...
ggsave(here("outputs", "plots", "amount_distribution.png"), plot = p1, width = 12, height = 4, dpi = 300)
...
ggsave(here("outputs", "plots", "log_amount_distribution.png"), plot = p2, width = 12, height = 4, dpi = 300)
...
ggsave(here("outputs", "plots", "time_distribution_by_class.png"), plot = p3, width = 12, height = 4, dpi = 300)