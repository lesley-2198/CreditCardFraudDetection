...
# After SMOTE step
save(train_data_smote, test_data, file = here("data", "processed", "smote_data.RData"))
...
write_csv(output_df, here("data", "processed", "logistic_smote_predictions.csv"))
saveRDS(log_model_smote, here("outputs", "models", "logistic_model_smote.rds"))

# Save confusion matrix
sink(here("outputs", "reports", "logistic_smote_confusion_matrix.txt"))
print(conf_matrix)
sink()

# Save yardstick metrics
write.csv(metrics, here("data", "processed", "logistic_smote_metrics.csv"), row.names = FALSE)
...
png(here("outputs", "plots", "roc_curve.png"), width = 800, height = 600)
...
png(here("outputs", "plots", "pr_curve.png"), width = 800, height = 600)
